...
| **AI原生ERP** | 使用langchain4j+ollama构建AI代理 | 开发中 |
...
该项目采用SpringCloud微服务开发，使用langchain4j构建AI代理，实现AI原生电商ERP系统。AI场景包括：
...
**启航电商 ERP** 专为大中型电商设计，依赖官方 API 实现自动化。如果您是中小卖家，面临以下问题：
* ❌ 无法申请淘宝、抖音、拼多多等平台的官方 API 权限。
* ❌ 业务量尚不需要复杂的全自动抓取逻辑。
* ❌ 只需要严谨的手动记账、Excel 导入对账和库存管理。

**建议使用我们的轻量化方案：**

👉 **[启航进销存 — Qihang Stock Books](https://gitee.com/qiliping/qihang-stock-books)**
