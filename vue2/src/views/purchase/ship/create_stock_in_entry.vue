<template>
  <div class="app-container">
    <el-card class="form-card">
      ...
      <el-form ref="form" :model="form" size="small" :rules="rules" :inline="true" label-width="128px">
        <el-col :span="24">
    ...
    <el-card class="items-card" style="margin-top: 20px;" v-if="form.status < 2">
      ...
      <el-form ref="form1" :model="form1" size="small" :rules="rules" :inline="true" label-width="128px">
        ...
        <el-row>
          <el-form-item label="备注"><el-input v-model="form1.remark" type="textarea" style="width: 220px" /> </el-form-item>
        </el-row>
        <el-row>
