<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="printParams" size="small" :inline="true" label-width="108px">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <!--      </el-col>-->
      <el-col :span="1.5">
        <el-select v-model="printParams.printer" size="mini" placeholder="请选择打印机" clearable>
          <el-option
            v-for="item in printerList"
            :key="item.name"
            :label="item.name"
